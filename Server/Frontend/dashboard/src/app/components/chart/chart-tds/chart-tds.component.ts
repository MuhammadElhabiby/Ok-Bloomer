...
@Component({
  selector: 'app-chart-tds',
  templateUrl: './chart-tds.component.html',
  styleUrls: ['./chart-tds.component.css']
})
export class ChartTdsComponent implements OnInit {
  ...
  public lineChartData = [
    {data: this.data.slice(this.dateStartIndex, this.dateEndIndex), label: "TDS"},
  ];
  ...
  ngAfterViewInit(){
    canvas = <HTMLCanvasElement> document.getElementById('canvasTds');
